...
function applyCssClass(rootView, cssClass) {
...
function removeCssClass(rootView, cssClass) {
    system_classes_1.removeFromRootViewCssClasses(cssClass);
...
function orientationChanged(rootView, newOrientation) {
    ...
    if (!rootView.cssClasses.has(newOrientationCssClass)) {
        ORIENTATION_CSS_CLASSES.forEach(function (cssClass) { return removeCssClass(rootView, cssClass); });
...
function systemAppearanceChanged(rootView, newSystemAppearance) {
    ...
    if (!rootView.cssClasses.has(newSystemAppearanceCssClass)) {
        SYSTEM_APPEARANCE_CSS_CLASSES.forEach(function (cssClass) { return removeCssClass(rootView, cssClass); });
